...
module.exports = {
    ...
    // 공격
    ATTACK_1 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Reconnaissance"},
    ATTACK_2 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Resource Development"},
    ATTACK_3 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Initial Access"},
    ATTACK_4 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Execution"},
    ATTACK_5 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Persistence"},
    ATTACK_6 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Privilege Escalation"},
    ATTACK_7 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Defense Evasion"},
    ATTACK_8 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Credential Access"},
    ATTACK_9 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Discovery"},
    ATTACK_10 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Lateral Movement"},
    ATTACK_11 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Collection"},
    ATTACK_12 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Command and Control"},
    ATTACK_13 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Exfiltration"},
    ATTACK_14 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Impact"},

    //대응 (나중에 tactic이랑 technique를 분리해야 함)
    DEFENSE_1 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Reconnaissance"},
    DEFENSE_2 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Resource Development"},
    DEFENSE_3 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Initial Access"},
    DEFENSE_4 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Execution"},
    DEFENSE_5 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Persistence"},
    DEFENSE_6 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Privilege Escalation"},
    DEFENSE_7 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Defense Evasion"},
    DEFENSE_8 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Credential Access"},
    DEFENSE_9 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Discovery"},
    DEFENSE_10 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Lateral Movement"},
    DEFENSE_11 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Collection"},
    DEFENSE_12 : { pita : [10, 20, 30, 50, 80], time : [9, 7, 6, 5, 4], success : [40, 50, 60, 70, 80], name : "Command and Control"},
    ...
    MONITORING_2 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Resource Development"},
    MONITORING_3 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Initial Access"},
    MONITORING_4 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Execution"},
    MONITORING_5 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Persistence"},
    MONITORING_6 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Privilege Escalation"},
    MONITORING_7 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Defense Evasion"},
    MONITORING_8 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Credential Access"},
    MONITORING_9 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Discovery"},
    MONITORING_10 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Lateral Movement"},
    MONITORING_11 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Collection"},
    MONITORING_12 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Command and Control"},
    MONITORING_13 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Exfiltration"},
    MONITORING_14 : { pita : [40, 80, 120, 200, 320], time : [9, 7, 6, 5, 4], name : "Impact"},
